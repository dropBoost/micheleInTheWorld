...
export default function LAYOUTPizzeria({ children }) {
    ...
    <div className="grid grid-cols-12 grid-rows-12 h-screen w-screen md:p-5 p-1 justify-center items-center bg-neutral-300">
        ...
        <div><Image src={"/logo-pizzeria-michele-foo.png"} width={70} height={50}/> </div>
        <div className="">
            <h1 className="text-xl font-normal text-neutral-100">
                Benvenut* <font className="uppercase font-bold">{nomeSede}</font>
            </h1>
            </div>
            <div className="flex flex-row gap-2">
            <button
                className="py-1 px-2 w-fit text-xs bg-brand-700 text-white rounded hover:bg-neutral-100 hover:text-brand"
            >
                CARICA ORDINE
            </button>
            <button
