  ...
  return (
    ...
    <div className="flex flex-col gap-4 p-4">
      <div className="flex flex-col justify-start">
        <h1 className="text-2xl font-bold mb-4 text-brand border border-brand rounded-lg py-2 px-4 w-fit">ORDINE PRODOTTI CASEARI DI BUFALA</h1>
      ...
      >
        ...
        <CampoOrdine name="stracciataDiBufala" label="Stracciata di Bufala" type="number"/>
        <CampoOrdine name="burrataDiBufala" label="Burrata di Bufala" type="number"/>
